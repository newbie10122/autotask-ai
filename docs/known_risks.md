...
**Mitigation:** Canonical control files, evidence-linked receipts, CI, independent verification, and sanitized Second Brain projection. Current reconciliation target is canonical `main` `8910014` through PR #103; Second Brain PR #13 is open at head `1068a9d` with local knowledge validation passing through PR #103.
